      ...
      <header className="sticky top-0 z-30 border-b border-white/10 bg-[#060a14]/80 backdrop-blur-xl">
        <div className="mx-auto flex w-full max-w-7xl items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-4">
            <a href="https://enoch3712.github.io/OfficePlane/docs/getting-started/quickstart" className="hidden sm:inline text-sm text-slate-400 transition hover:text-white">
              Docs
            </a>
            <a
              href={repoUrl}
        ...
        <section className="relative mx-auto max-w-7xl px-6 pb-24 pt-20 sm:pt-28">
          ...
          <div className="relative text-center">
            ...
            <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
              ...
              <a
                href="https://enoch3712.github.io/OfficePlane/docs/getting-started/quickstart"
